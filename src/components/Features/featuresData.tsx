...
const featuresData: Feature[] = [
  {
    ...
    title: "رسته",
    paragraph:
      "گروهی از مشاغل که دارای اهداف، وظایف و ماهیت کاری مشابه هستند. مانند: هوش تهدیدات سایبری، پاسخ به رخدادها، مدیریت ریسک و غیره.",
  },
  {
    id: 2,
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        <path d="M14 10C14 8 16 6 20 6C24 6 26 8 26 10V12H14V10Z" />
        <rect x="4" y="12" width="32" height="20" rx="3" ry="3" />
        <rect x="4" y="20" width="32" height="2" />
        <rect x="18" y="18" width="4" height="6" rx="1" />
        <rect x="10" y="24" width="2" height="6" rx="1" opacity="0.4"/>
        <rect x="28" y="24" width="2" height="6" rx="1" opacity="0.4"/>
        <rect x="6" y="30" width="28" height="1.5" rx="0.75" opacity="0.3"/>
      </svg>
    ),
    title: "شغل",
    paragraph:
      "عنوان رسمی که سازمان‌ها برای موقعیت‌های شغلی به کار می‌برند. این عنوان می‌تواند در سطوح مختلف سازمانی متغیر باشد (تحلیلگر، مهندس، مشاور، مدیر).",
  },
  {
    id: 3,
    icon: (
    ...
    title: "نقش",
    paragraph:
      "شرح کلی وظیفه یا مسئولیتی که فرد در تیم یا پروژه ایفا می‌کند. نقش، نگاه کاربردی‌تر به جایگاه فرد در سازمان دارد.",
  },
  {
    id: 4,
    icon: (
    ...
    title: "مسئولیت ها",
    paragraph:
      "فهرستی از حوزه‌هایی که فرد باید در آن‌ها اقدام کند یا پاسخگو باشد. این سطح، حوزه وظایف کلی‌تر و بلندمدت‌تر را شامل می‌شود.",
  },
  {
    id: 5,
    icon: (
    ...
    title: "وظایف",
    paragraph:
      "اقدامات عملیاتی و روزانه که فرد برای تحقق مسئولیت‌های خود انجام می‌دهد. وظایف باید مشخص، قابل سنجش و شفاف باشند.",
  },
  {
    id: 6,
    icon: (
      <svg width="40" height="45" viewBox="0 0 40 45" className="fill-current">
        <circle cx="20" cy="14" r="9" opacity="0.12" />
        <circle cx="20" cy="14" r="7.2" />
        <circle cx="20" cy="14" r="3.8" opacity="0.06" />
        <polygon points="20,9.5 21.176,12.382 24.28,12.609 21.902,14.618 22.645,17.641 20,16 17.355,17.641 18.098,14.618 15.72,12.609 18.824,12.382" />
        <circle cx="20" cy="14" r="7.8" fill="none" stroke="currentColor" strokeWidth="0.6" opacity="0.12"/>
        <path d="M14 22 L12 33 C12 34 13.2 34.6 14.2 33.7 L17 29.5" />
        <path d="M26 22 L28 33 C28 34 26.8 34.6 25.8 33.7 L23 29.5" />
        <path d="M13.2 25.5 L15.6 26.8" opacity="0.12" />
        <path d="M26.8 25.5 L24.4 26.8" opacity="0.12" />
      </svg>
    ),
    title: "تخصص ها",
    paragraph:
      "توانایی‌ها و قابلیت‌های فنی یا بین‌فردی که فرد باید داشته باشد تا وظایف خود را مؤثر انجام دهد. مهارت‌ها قابل آموزش و توسعه هستند.",
  },
  {
    id: 7,
    icon: (
      <svg width="150" height="150" viewBox="0 0 40 45" className="fill-current">
        <rect x="4" y="10" width="14" height="20" rx="2" fill="currentColor" opacity="0.1"/>
        <rect x="7" y="13" width="9" height="1.4" rx="0.7" fill="currentColor" opacity="0.25"/>
        <rect x="7" y="17" width="9" height="1.4" rx="0.7" fill="currentColor" opacity="0.25"/>
        <rect x="7" y="21" width="7" height="1.4" rx="0.7" fill="currentColor" opacity="0.25"/>
        <rect x="22" y="10" width="14" height="20" rx="2" fill="currentColor" opacity="0.1"/>
        <rect x="24" y="13" width="9" height="1.4" rx="0.7" fill="currentColor" opacity="0.25"/>
        <rect x="24" y="17" width="9" height="1.4" rx="0.7" fill="currentColor" opacity="0.25"/>
        <rect x="26" y="21" width="7" height="1.4" rx="0.7" fill="currentColor" opacity="0.25"/>
        <rect x="18.6" y="8" width="2.8" height="24" rx="1" fill="currentColor" opacity="0.45"/>
        <rect x="4" y="30" width="32" height="2" rx="1" fill="currentColor" opacity="0.03"/>
      </svg>
    ),
    title: "دانش ها",
    paragraph:
      "مبانی نظری، اصول علمی و اطلاعات تخصصی که فرد برای تحلیل مسائل و تصمیم‌گیری نیاز دارد. داشتن دانش عمیق، پایه اجرای صحیح تخصص‌هاست.",
  },
  {
    id: 7,
    icon: (
      <svg width="150" height="150" viewBox="-10 -10 60 65" className="fill-current">

          <rect x="4" y="6" width="32" height="33" rx="3" fill="currentColor" opacity="0.07"/>
          <path d="M10 5.5h4a1 1 0 0 1 1 1V8a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1V6.5a1 1 0 0 1 1-1z" fill="currentColor" opacity="0.12" transform="translate(0,0)"/>

          <rect x="7" y="10" width="26" height="26" rx="2" fill="white"/>

          <rect x="14" y="4" width="12" height="4" rx="1" fill="currentColor" opacity="0.15"/>

          <g transform="translate(9,13)">
            <rect x="6" y="0" width="13" height="2" rx="1" fill="currentColor" opacity="0.22"/>
            <circle cx="3" cy="1" r="2.2" fill="none" stroke="currentColor" strokeWidth="0.9" opacity="0.6"/>
            <path d="M2.1 1.0 L2.8 1.7 L4.6 0.0" stroke="currentColor" strokeWidth="0.9" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.9"/>
            <rect x="6" y="7" width="18" height="2" rx="1" fill="currentColor" opacity="0.18"/>
            <circle cx="3" cy="8" r="2.2" fill="none" stroke="currentColor" strokeWidth="0.9" opacity="0.45"/>
            <rect x="6" y="14" width="12" height="2" rx="1" fill="currentColor" opacity="0.18"/>
            <circle cx="3" cy="15" r="2.2" fill="none" stroke="currentColor" strokeWidth="0.9" opacity="0.45"/>
          </g>

          <g transform="translate(24,26) rotate(-18 0 0)">
            <rect x="-0.6" y="-8" width="1.6" height="10" rx="0.5" fill="currentColor" opacity="0.9"/>
            <path d="M1 2.2 L4 5.7 L6.6 3.7 L3.6 0.2 Z" fill="currentColor" opacity="0.95" transform="translate(-0.8,-2)"/>
            <path d="M6.6 3.7 L7.4 4.6 L6 6.0 L5.2 5.1 Z" fill="currentColor" opacity="0.95" transform="translate(-0.8,-2)"/>
          </g>

          <rect x="7" y="30" width="26" height="2" rx="1" fill="currentColor" opacity="0.03"/>

        </svg>
    ),
    title: "معیارهای احراز و آزمون ورودی",
    paragraph:
      "معیارهای احراز و آزمون ورودی شامل حداقل دانش، مهارت و تخصص لازم برای ورود به شغل است که از طریق آزمون‌های بین‌المللی و سیلابس مربوطه ارزیابی می‌شود تا شایستگی فرد برای انجام وظایف اصلی شغل تأیید شود.",
  },
];
